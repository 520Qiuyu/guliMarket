    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :currentImage="currentImage" />
          <!-- 小图列表 -->
          <ImageList
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                ...
                <!-- 属性值 -->
                <dd
                  :class="spuSaleAttrValue.isChecked === '1' ? 'active' : ''"
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a class="mins" @click="minSkuNum">-</a>
              </div>
              <div class="add">
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const minSkuNum = () => {
      if (skuNum.value <= 1) return (skuNum.value = 1);
      else skuNum.value--;
    };
    const changeActive = (
      spuSaleAttrValue: spuSaleAttrValue,
    ...
    const setCurrentImage = (id: number) => {
      currentImage.value = skuInfo.value.skuImageList?.filter(
        (item) => item.id === id
      )[0].imgUrl;
    };
    const addToCart = async () => {
      try {
        ...
        sessionStorage.setItem(
          "spuSaleAttrList",
          JSON.stringify(spuSaleAttrList.value)
        );
        Router.push({
          name: "addcartsuccess",
          query: {
  ...
  created() {
    this.Store.dispatch("goods/getSkuDetail", this.$route.params.skuId);
  },
});
</script>
